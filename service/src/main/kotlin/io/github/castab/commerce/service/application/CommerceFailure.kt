package io.github.castab.commerce.service.application

/**
 * An expected failure of an application operation.
 *
...
sealed class CommerceFailure(
     ...
     * its types; this is how the service reports a request for one that does not exist.
     */
